...
🤖 Curious about AI, LLMs & building things that actually ship  
...
### 🚗 Estimihali — Car Price Estimator
> Web app for estimating car prices on the Algerian market using Machine Learning  
> `Python` `Scikit-learn` `JavaScript` `HTML/CSS`  
> 🔗 [View Project](https://lnkd.in/d2N7UBR5)

### 🛒 Délices Sucrés — E-commerce
> Full-stack online shop for an artisanal pastry brand  
> `PHP` `MySQL` `HTML5` `CSS3` `JavaScript`

### 📊 Mabbiti Admin Dashboard
> Complete admin dashboard with multilingual support (FR/EN/AR) and RTL management  
> `React.js` `Vite` `Tailwind CSS` `Laravel` `Axios`
